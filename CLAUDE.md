...
**YOU ARE IN: `darkdisco/polecats/guzzle/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/darkdisco/` (rig root) or other directories
...
**Your mail address:** `darkdisco/polecats/guzzle`
**Your rig:** darkdisco
**Your Witness:** `darkdisco/witness`
...
| Ask Witness for help | `gt mail send darkdisco/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`darkdisco/witness`) when:
...
```bash
gt mail send darkdisco/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
